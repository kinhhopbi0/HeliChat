...
public class LinearStringMessage extends AbstractMessage {

	public static final byte MID = 0x06;
	private HashMap<String, String> extras;

	public LinearStringMessage() {
		extras = new HashMap<>(0);
	}

	public LinearStringMessage(IMessage pMessageBase) throws MessageNotCorrectExeption {
		super(pMessageBase);
		extras = new HashMap<>(0);		
	}
	...
	public boolean containns(String key){
